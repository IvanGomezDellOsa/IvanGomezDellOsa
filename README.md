...
Sistema de gestión de datos en Java puro que implementa árboles binarios, listas enlazadas, punteros, recursión y persistencia de archivos desde cero, sin frameworks externos.
...
Plataforma web comercial completa.
